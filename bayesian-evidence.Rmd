...
.big[`r fa("feather-alt",,"white")` `r fa("markdown",,"white")` [.white[Raw rmarkdown file]](https://github.com/mattansb/bayesian-evidence/blob/main/bayesian-evidence.Rmd)]  
...
`r fa("desktop")` Link to similar presentation:  
[tinyurl.com/bayesian-evidence](https://tinyurl.com/bayesian-evidence)

<br>

`r fa("github")` All the code and materials used in this workshop can be found on GitHub:  
[github.com/mattansb/bayesian-evidence](https://github.com/mattansb/bayesian-evidence)

<br>

`r fa("youtube")` Watch a recording of this talk on YouTube:  
[youtu.be/E-HYh0Q_6xM](https://www.youtube.com/watch?v=E-HYh0Q_6xM)
...
.right[
See the full analysis script [here `r fa("link",,link_color)`](https://mattansb.github.io/bayesian-evidence/files/full%20analysis%20script.nb.html)
]
...
.footnote[
[See other package versions and packages used `r fa("link",,link_color)`](https://mattansb.github.io/bayesian-evidence/files/full%20analysis%20script.nb.html#setup)
]
...
.footnote[
But you can find them, and more, in [the full analysis script `r fa("link",,link_color)`](https://mattansb.github.io/bayesian-evidence/files/full%20analysis%20script.nb.html)...
]
...
describe_posterior(diffs_Congruency, test = NULL, ci = .89)
```
...
describe_posterior(slope_age, test = NULL, ci = .89)
```
