...
We first need to obtain a model that represents purly our priors - before that have been updated by the data - which we will then *compare* to the results from our updated (posterior) model.
