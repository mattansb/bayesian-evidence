...
.right[
See the full analysis script [here `r fa("link",,link_color)`](files/full%20analysis%20script.nb.html)
]
...
.footnote[
[See other packages used `r fa("link",,link_color)`](files/full%20analysis%20script.nb.html#setup)
]
...
.footnote[
But you can find them, and more, in [the full analysis script `r fa("link",,link_color)`](files/full%20analysis%20script.nb.html)...
]
...
We first need to obtain a model that represents purely our priors - before that have been updated by the data - which we will then *compare* to the results from our updated (posterior) model.
...
Wow! It seems that the data strongly support (by a factor of 1/0.05 = 20) the effect of age being null over it being outside the ROPE!
...
DO NOT COMPUTE BAYES FACTORS (vs. *null*) WITH UNINFORMATIVE PRIORS!
]
...
<h3><i>What you now know! `r fa("graduation-cap",,"white")`</i></h3>
