...
By comparing .blue[The Prior] to .green[The Posterior], we can see what values became more or less plausible.

--

We can use this information to look at different *sets of parameter values* - or **hypotheses** - E.g. $H_1: \theta \in [0.5, 3]$, $H_2: \theta \in [1, 200]$ and ask:
...
For the ROPE - I think any effect smaller an overall change change of less than 500ms a year = ~40ms a month, is practically 0 (you may disagree…):
